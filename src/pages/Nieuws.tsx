  ...
  return (
    <>
      <SEO
        ...
        description="Blijf op de hoogte van het laatste nieuws over dakwerken, innovaties en trends in de dakbedekkingsbranche."
        canonical="/nieuws"
      />
      ...
      <section className="relative bg-black pt-32 pb-16 md:pt-40 md:pb-24 px-4 md:px-6 overflow-hidden h-screen flex items-center">
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            ...
            <span className="text-brand-green font-bold text-xs uppercase tracking-[0.3em]">Blog & Insights</span>
          </motion.div>
          ...
          <div className="container mx-auto">
            ...
            >
              ...
              <div className="lg:pl-8">
                ...
                <Link
                  to={`/nieuws/${featuredPost.id}`}
                  className="inline-flex items-center gap-3 bg-slate-900 hover:bg-brand-green text-white px-8 py-4 rounded-xl font-bold uppercase text-sm tracking-wider transition-all duration-300 group"
                >
                  Lees artikel
      ...
      <section className="py-20 md:py-28 px-4 md:px-6 bg-black relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 text-center max-w-2xl">
          ...
          >
            ...
            <Link
              to="/contact"
              className="inline-flex items-center gap-3 bg-brand-green hover:bg-white hover:text-slate-900 text-white px-10 py-5 rounded-xl font-bold uppercase text-sm tracking-wider transition-all duration-300 group"
            >
              Neem contact op
              <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
            </Link>
