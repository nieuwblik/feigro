      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative">
            ...
            <FadeIn delay={0.2} distance={40} className="absolute -bottom-6 -right-6 md:-right-12 z-20 parallax-fast" style={{ '--parallax-speed': '0.15' } as any}>
              <div className="bg-white border border-slate-200 text-slate-900 p-8 md:p-12 rounded-[0.5rem] md:rounded-[0.75rem]">
          ...
          <div className="flex flex-col">
            ...
            <FadeIn delay={0.1}>
              <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl font-heading text-slate-900 leading-[0.9] tracking-tighter mb-10 uppercase">
                Uw dak is bij ons <br /><span className="text-brand-green italic">In goede handen</span>
              </h2>
            </FadeIn>

            <FadeIn delay={0.2}>
              <p className="text-slate-600 text-lg md:text-xl mb-12 leading-relaxed max-w-xl font-light">
