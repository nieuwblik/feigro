...
export const Services = () => {
  return (
    <>
      <section id="diensten" className="py-20 md:py-28 lg:py-36 bg-slate-50 overflow-hidden border-t border-slate-100 relative">
            ...
            {servicesList.map((service, i) => (
              <FadeIn key={i} delay={i * 0.05} distance={20}>
                <Link to={service.href} className="block h-full">
                  <div
                    className="group relative p-8 md:p-10 lg:p-12 rounded-xl md:rounded-[1.25rem] bg-white border border-slate-200 hover:border-brand-green/30 transition-all duration-500 flex flex-col h-full min-h-[320px] md:min-h-[380px] overflow-hidden select-none hover:-translate-y-2"
                  >
