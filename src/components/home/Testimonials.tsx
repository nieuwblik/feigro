...
export const Testimonials = () => {
  ...
  return (
    <section className="py-20 md:py-28 lg:py-36 bg-slate-50 overflow-hidden relative">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-12 gap-12 md:gap-16 items-center">

          <div className="lg:col-span-5 flex flex-col items-center md:items-start z-10">
            <FadeIn>
            ...
            <FadeIn delay={0.1}>
              <h2 className="text-3xl md:text-5xl font-heading text-slate-900 leading-[0.9] tracking-tighter uppercase mb-8 lg:text-5xl text-center md:text-left">
                Feedback van <br />
            ...
            <FadeIn delay={0.2}>
              <p className="text-slate-600 text-lg leading-relaxed mb-10 max-w-md font-light text-center md:text-left">
            ...
            <FadeIn delay={0.3} className="w-full md:w-auto">
              <div className="flex flex-col gap-3 mb-12 w-full md:w-auto">
                <PrimaryFlipButton 
                  label="Plaats review voor FEIGRO" 
                  size="default" 
                  onClick={() => window.open('https://www.google.com/search?client=firefox-b-d&hs=fpCp&sca_esv=20541e4f21a9d7f7&q=Feitsma+Dakwerken+Reviews&rflfq=1&num=20&stick=H4sIAAAAAAAAAONgkxK2NDMxtzAxMDE0MbMwMTU3MjIy38DI-IpR0i01s6Q4N1HBJTG7PLUoOzVPISi1LDO1vHgRK245AKTYdrtSAAAA&rldimm=9647840414684572227&tbm=lcl&hl=nl-NL&sa=X&ved=2ahUKEwjN6eaW95ySAxVd3AIHHfHbKcMQ9fQKegQIMBAG&biw=2422&bih=1171&dpr=1.54&aic=0#lkt=LocalPoiReviews', '_blank')} 
                />
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.4}>
              <div className="flex items-center justify-center md:justify-start gap-4 w-full">
                <button 
                  onClick={prev} 
                  className="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-brand-green hover:text-white hover:border-brand-green active:scale-95 transition-all duration-300 group" 
            ...
            <div className="relative w-full min-h-[500px] flex items-center">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="w-full md:w-[60%] relative p-8 md:p-12 rounded-[1.25rem] bg-white border border-slate-200 hover:border-brand-green/30 transition-all duration-500 flex flex-col justify-between overflow-hidden group hover:-translate-y-2">
