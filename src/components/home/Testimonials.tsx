...
export const Testimonials = () => {
  ...
  return <section className="py-24 md:py-32 bg-slate-50 overflow-hidden relative">
            <div className="container mx-auto px-6">
                <div className="grid lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-5 flex flex-col items-start z-10">
                        ...
                        <FadeIn delay={0.1}>
                            <h2 className="text-3xl md:text-5xl font-heading text-slate-900 leading-[0.9] tracking-tighter uppercase mb-6 lg:text-5xl">
                                Feedback van <br />
