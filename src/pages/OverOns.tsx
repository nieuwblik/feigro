        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <FadeIn direction="left">
              <div>
                <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-heading text-slate-900 mb-6 md:mb-10 tracking-tight uppercase">
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-slate-50 border-y border-slate-100">
        <div className="container mx-auto px-4 md:px-6">
          <FadeIn className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-heading text-slate-900 leading-[0.9] tracking-tighter uppercase mb-4 md:mb-6">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            <div className="lg:w-1/2">
              <FadeIn>
                <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl font-heading text-slate-900 mb-8 md:mb-12 leading-none uppercase tracking-tighter">
