    ...
    <section className="py-16 md:py-24 lg:py-32 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        {projectsList.length === 0 ? <div className="text-center py-20">
          ...
          {projectsList.map((project, index) => <motion.div key={project.slug} initial={{
            opacity: 0,
            y: 40
          }} whileInView={{
            opacity: 1,
            ...
            <Link to={`/projecten/${project.slug}`} className="group block">
              ...
              <div className="relative aspect-[16/10] overflow-hidden rounded-xl md:rounded-2xl mb-6 md:mb-8 border border-slate-200">
                <img src={project.imageAfter} alt={project.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{
            ...
            {[...Array(5)].map((_, i) => <Star key={i} size={20} className="fill-brand-green text-brand-green" />)}
          </motion.div>
          ...
          <div className="grid gap-6 md:gap-8">
            {[{
              ...
              city: "Den Haag"
            }].map((review, i) => <motion.div key={i} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
              ...
              once: true
            }} className="relative p-6 md:p-10 bg-white border border-slate-200 rounded-xl md:rounded-2xl transition-all duration-300">
