            ...
            <div className="container mx-auto px-6">
                <div className="grid lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-5 flex flex-col items-start z-10">
                        ...
                        <FadeIn delay={0.2}>
                            <p className="text-slate-600 text-lg leading-relaxed mb-8 max-w-md font-light">
                        ...
                        <FadeIn delay={0.4}>
                            <div className="flex items-center gap-4">
                                <button
                                    onClick={prev}
                                    className="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-brand-green hover:text-white hover:border-brand-green transition-all duration-300 group"
                        ...
                        <div className="relative w-full min-h-[500px] flex items-center">
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    <div className="w-full md:w-[60%] relative p-8 md:p-10 rounded-[1.25rem] bg-white border border-slate-200 hover:border-brand-green/30 transition-all duration-500 flex flex-col justify-between overflow-hidden group hover:-translate-y-2">
